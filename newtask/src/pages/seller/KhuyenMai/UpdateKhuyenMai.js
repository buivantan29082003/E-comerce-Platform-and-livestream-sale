...
const UpdateKhuyenMai = () => {
        ...
        let a=Array.from(listProduct.keys()).splice(length)
            toast.promise(
                ...
                }),
                {
                  ...
                  loading: "Updating khuyến mãi.....", 
                  success: 'Update khuyến mãi successfully.', 
    ...
    const deleleItems=()=>{
        api.post(`/khuyenmai/deleteitems/${khuyenMai.id}`,Array.from(size),{
            ...
            alert("Danh sách các sản phẩm items không hợp lệ")
        })
    }


    const checkValidProduct=()=>{
        api.post("/khuyenmai/checkvalidupdate?id="+id, {
            ...
            if(v.length>0){
                toast.error("Có một số sản phẩm đã loại bỏ do nằm tong chương trình khuyên mãi khác")
                v.forEach(vv => {
            ...
            <div style={{ borderRadius: '7px' }} className="shadow-md mt-3 container mx-auto p-4 relative bg-white">
                ...
                <div class="container mx-auto mt-3">
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 lg:col-span-2 text-sm font-semibold  lg:text-right sm:text-left">Tên khuyến mãi</div>
                ...
                <div class="container mx-auto mt-3">
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 lg:col-span-10">
                            <input 
                                min={new Date(khuyenMai.ngayBatDau).toISOString().slice(0, 16)}
                                max={new Date(khuyenMai.ngayKetThuc).toISOString().slice(0, 16)}
                                onChange={(e) => {
