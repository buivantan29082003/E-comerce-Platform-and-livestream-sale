...
const ReviewCard = React.memo(({ review }) => {
    ...
    const updateComment=(value)=>{
        api.post(`/danhgia/updatecommentdanhgia?danhGiaId=${review.id}`,value,{
            headers:{
    ...
    return (
        <div className="bg-white min-h-screen py-8 px-4">
            <div class="p-4">
                ...
                }} className="mr-2 w-5/12 lg:w-3/12 p-2 d-inline-block " placeholder='Tên tài khoản, nội dung đánh giá'/>
                </div>
                <Stack spacing={4}>
