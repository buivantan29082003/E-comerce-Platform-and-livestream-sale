...
import OrderItemGiaoThanhCong from './OrderItemGiaoThanhCong';
const OrderGiaoThanhCong = ({ trangThai }) => {
        ...
        <>
            <div>
                ...
                <table className="min-w-full text-center table-auto border-collapse">
                    ...
                    <tbody ref={tableRef}>
                        {orders.map((v, index) => (
                            <OrderItemGiaoThanhCong trangThai={trangThai} index={index} removeOrder={removeOrder} order={v} />
                        ))}
                    </tbody>
                </table>
                {/* <div ref={tableRef}>
...
export default OrderGiaoThanhCong;
