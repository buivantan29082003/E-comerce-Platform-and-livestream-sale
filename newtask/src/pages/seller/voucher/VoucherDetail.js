                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6 text-sm text-gray-600">
                        ...
                        <div>
                            ...
                            <p className="text-sm">
                                ...
                                {new Date(data.voucher.ngayBatDau).toLocaleTimeString("vi-VN")} - {new Date(data.voucher.ngayKetThuc).toLocaleTimeString("vi-VN")}
                                <br />
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
                                        <thead class="bg-gray-700">
                                            <tr>
                                                <th class="px-6 py-3 text-left text-white-900 font-semibold">sản phẩm</th>
                                                <th class="px-6 py-3 text-left text-white-900 font-semibold">Số lượng</th>
                                                <th class="px-6 py-3 text-left text-white-900 font-semibold">Min price</th>
                                                <th class="px-6 py-3 text-left text-white-900 font-semibold">Max price</th>
