...
public class LiveController {
	...
	@GetMapping("/live/getalllive")
	public Object getMethodNames(@RequestParam(name="id",defaultValue = "-1")Integer id) {
		List<LiveSession> list=liveReository.getAllLive(id);
		return new ObjectRespone(200,"", list);
	}
	...
	@GetMapping("/live/getshopislive")
	public Object getShopIsLive(@RequestParam(name="id",defaultValue = "1")Integer id) {
		return new ObjectRespone(200, null,liveReository.getShopIsLive(id));
	}
